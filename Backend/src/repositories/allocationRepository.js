  ...
  try {
    ...
    await connection.query(
      ...
      [
        ...
        now,
        cleanReason,
        manualDocumentUrl || null,
        manualDocumentName || null,
        now,
        createdBy || null,
      ]
    );
...
async function listAllocationsByHallId(
  ...
  const [rows] = await pool.query(
    `SELECT sa.allocationId,
            ...
            sa.remarks,
            sa.reason,
            sa.manualDocumentUrl,
            sa.manualDocumentName,
            sa.created_at,
            sa.updated_at,
  ...
  return rows.map((r) => ({
    ...
    manualDocument: r.manualDocumentUrl
      ? {
          url: r.manualDocumentUrl,
          name: r.manualDocumentName || null,
        }
      : null,
