              ...
              >
                ...
                {filterManualOnly && (
                  <div className="mt-3 text-sm">
                    ...
                    {a?.manualDocument?.url ? (
                      <a
                        href={toPublicUrl(a.manualDocument.url)}
                        target="_blank"
                        rel="noreferrer"
                        className="inline-block mt-1 text-xs text-emerald-700 hover:text-emerald-800 underline"
                      >
                        View Document
                      </a>
                    ) : null}
